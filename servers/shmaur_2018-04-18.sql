...
# Database: shmaur
# Generation Time: 2018-04-17 16:13:01 +0000
# ************************************************************
...
CREATE TABLE `article` (
  ...
  `article_type_id` int(20) DEFAULT NULL COMMENT '文章类型id',
...
CREATE TABLE `articleImg` (
  ...
  `img_type` int(3) DEFAULT NULL COMMENT '上传类型',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `articleImg` WRITE;
/*!40000 ALTER TABLE `articleImg` DISABLE KEYS */;

INSERT INTO `articleImg` (`id`, `user_id`, `img_name`, `img_path`, `img_time`, `img_type`)
VALUES
	(38,1,'0.jpeg','/Users/shmaur/Documents/Vue_Project/bolg/shmaurAdmin/servers/public/img/artImg/0.jpeg','2018-04-16 21:55:58',NULL);
...
CREATE TABLE `articleType` (
  ...
  `type_parent` int(11) DEFAULT NULL COMMENT '上级分类',
  `type_found` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `type_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `articleType` (`id`, `type_name`, `type_parent`, `type_found`, `type_modified`)
VALUES
	(3,'jss',1,'2018-04-17 18:18:41','2018-04-17 18:18:41'),
	(4,'jsss',1,'2018-04-17 18:19:43','2018-04-17 18:19:43'),
	(5,'js',1,'2018-04-17 18:21:48','2018-04-17 18:21:48'),
	(6,'vue',1,'2018-04-17 18:25:54','2018-04-17 18:25:54'),
	(7,'ang',888,'2018-04-17 18:30:17','2018-04-17 22:14:07');
...
CREATE TABLE `notices` (
  ...
  `notices_content` varchar(300) DEFAULT '' COMMENT '通知内容',
  `notices_found` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `notices_title` varchar(50) DEFAULT NULL COMMENT '通知标题',
  `notices_img` varchar(100) DEFAULT NULL COMMENT '通知图片',
  `notices_user` varchar(30) DEFAULT NULL COMMENT '发布人',
  `notices_issue` tinyint(1) DEFAULT NULL COMMENT '是否发布',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `tag` (
  ...
  `tag_found` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `tag_modified` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最后修改时间',
  `tag_user` varchar(50) DEFAULT NULL COMMENT '创建人',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
